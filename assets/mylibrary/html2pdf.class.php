...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
        ...
        protected $_isAfterFloat     = true;       // flag : is just after a float
        protected $_isInForm         = true;       // flag : is in a float. false / action of the form
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='utf+-8', $marges = array(3, 3, 3, 3))
        {
